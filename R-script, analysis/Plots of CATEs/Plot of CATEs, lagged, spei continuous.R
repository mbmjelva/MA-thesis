## CATEs, SPEI continuous, lagged ##

library(tidyverse)

# Spei neg
load(file = "./R-script, analysis/Models/cates_neg_with_target.rds")
...
ggsave("./Figurer/cates_neg, spei cont, target, seven variables 1.png", height = 15, width = 11)
...
ggsave("./Figurer/cates_neg, spei cont, target, seven variables 2.png", height = 15, width = 11)


# Spei pos
load(file = "./R-script, analysis/Models/cates_pos_with_target.rds")
...
ggsave("./Figurer/cates_pos, spei cont, target, seven variables 1.png",  height = 15, width = 11)
...
ggsave("./Figurer/cates_pos, spei cont, target, seven variables 2.png", height = 15, width = 11)
