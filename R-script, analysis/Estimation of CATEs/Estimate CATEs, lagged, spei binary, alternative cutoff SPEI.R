### Estimation of CATEs ###
# Lagged, spei binary, alternative cut-off SPEI
...
load(file = "./R-script, analysis/Models/cf_neg_lagged_speidich_altcutpoint.rds")

train_speineg <- readRDS(file = "./R-script, analysis/Models/train_speineg_lagged_speidich_altcutpoint.rds")
test_speineg <- readRDS(file = "./R-script, analysis/Models/test_speineg_lagged_speidich_altcutpoint.rds")
...
save(cates_neg, file = "./R-script, analysis/Models/cates_neg_speidich__altcutpoint_with_target.rds")
...
load(file = "./R-script, analysis/Models/cf_pos_lagged_speidich_altcutpoint.rds")

train_speipos <- readRDS(file = "./R-script, analysis/Models/train_speipos_lagged_speidich_altcutpoint.rds")
test_speipos <- readRDS(file = "./R-script, analysis/Models/test_speipos_lagged_speidich_altcutpoint.rds")
...
save(cates_pos, file = "./R-script, analysis/Models/cates_pos_speidich_altcutpoint_with_target.rds")
