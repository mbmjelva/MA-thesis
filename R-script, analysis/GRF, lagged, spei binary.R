# Generalized random forest - lagged model, SPEI dikotom #
...
cf_neg <- causal_forest(
  ...
  num.trees = 5000, # Fit more trees than the default (defult is 2000) as recommended by authors when wanting variance estimates
  mtry = NULL,
  min.node.size = NULL,
...
# Save the model
save(cf_neg, file = "./R-script, analysis/Models/cf_neg_lagged_speidich_tuned.rds")
