...
sample_final <- filter(sample_final, continent == "Asia")
...
saveRDS(train_speipos, "./R-script, analysis/Models/train_speipos_lagged_speidich_only_conflict_asia.rds")
saveRDS(train_speineg, "./R-script, analysis/Models/train_speineg_lagged_speidich_only_conflict_asia.rds")

saveRDS(test_speipos, "./R-script, analysis/Models/test_speipos_lagged_speidich_only_conflict_asia.rds")
saveRDS(test_speineg, "./R-script, analysis/Models/test_speineg_lagged_speidich_only_conflict_asia.rds")
...
# Save the model
save(cf_neg_speidich, file = "./R-script, analysis/Models/cf_neg_lagged_speidich_only_conflict_asia.rds")
...
save(cf_pos_speidich, file = "./R-script, analysis/Models/cf_pos_lagged_speidich_only_conflict_asia.rds")
