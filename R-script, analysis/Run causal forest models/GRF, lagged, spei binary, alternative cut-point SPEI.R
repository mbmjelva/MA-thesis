...
saveRDS(train_speipos, "./R-script, analysis/Models/train_speipos_lagged_speidich_alt_cutpoint.rds")
saveRDS(train_speineg, "./R-script, analysis/Models/train_speineg_lagged_speidich_alt_cutpoint.rds")

saveRDS(test_speipos, "./R-script, analysis/Models/test_speipos_lagged_speidich_alt_cutpoint.rds")
saveRDS(test_speineg, "./R-script, analysis/Models/test_speineg_lagged_speidich_alt_cutpoint.rds")
