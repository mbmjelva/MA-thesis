...
# Choose only grid cells in Africa
sample_final <- filter(sample_final, continent == "Americas")
...
saveRDS(train_speipos, "./R-script, analysis/Models/train_speipos_lagged_speidich_only_conflict_america.rds")
saveRDS(train_speineg, "./R-script, analysis/Models/train_speineg_lagged_speidich_only_conflict_america.rds")

saveRDS(test_speipos, "./R-script, analysis/Models/test_speipos_lagged_speidich_only_conflict_america.rds")
saveRDS(test_speineg, "./R-script, analysis/Models/test_speineg_lagged_speidich_only_conflict_america.rds")
...
# Save the model
save(cf_neg_speidich, file = "./R-script, analysis/Models/cf_neg_lagged_speidich_only_conflict_america.rds")
...
save(cf_pos_speidich, file = "./R-script, analysis/Models/cf_pos_lagged_speidich_only_conflict_america.rds")
