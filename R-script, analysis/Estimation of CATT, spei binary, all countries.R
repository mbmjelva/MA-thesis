### Estimation of CATT, SPEI binary, all countries ###
...
save(catt_neg, file = "./R-script, analysis/Models/catt_neg_speidich.rds")
...
save(catt_pos, file = "./R-script, analysis/Models/catt_pos_speidich.rds")
