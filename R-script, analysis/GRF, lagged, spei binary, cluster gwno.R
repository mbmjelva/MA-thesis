# Generalized random forest - lagged model, SPEI dikotom, cluster gwno #
...
cf_neg_dich_clgwno <- causal_forest(
...
# Save the model
save(cf_neg_dich_clgwno, file = "./R-script, analysis/Models/cf_neg_lagged_speidich_cl_gwno.rds")


# Model with positive SPEI
cf_pos_dich_clgwno <- causal_forest(
...
save(cf_pos_dich_clgwno, file = "./R-script, analysis/Models/cf_pos_lagged_speidich_cl_gwno.rds")
