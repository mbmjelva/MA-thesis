## Plots of CATEs, speidich, overlap, with continuous treatment variable ##

# This script creates the plots of CATEs for subgroups, presented in the Analysis and Appendix C
# With continuous treatment variable

library(tidyverse)

load(file = "./R-script, analysis/Models/cates_neg_oveerlap_continuous.rds")
load(file = "./R-script, analysis/Models/cates_pos_overlap_continuous.rds")
...
ggsave("./Figurer/cates neg, spei continuous, overlap, all vars 1.png", height = 15, width = 11)
...
ggsave("./Figurer/cates neg, spei continuous, overlap, all vars 2.png", height = 15, width = 11)
...
ggsave("./Figurer/cates pos, spei continuous, overlap, all vars 1.png", height = 15, width = 11)
...
ggsave("./Figurer/cates pos, spei continuous, overlap, all vars 2.png", height = 15, width = 11)
